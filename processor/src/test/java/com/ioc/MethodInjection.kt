...
class MethodInjection : BaseTest {
    ...
    fun singletons() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ParentActivityInjector",
            ...
            "",
            "   public static final ParentDependency provideParentDependency() {",
            "       DependencyModel dependencyModel = new DependencyModel(SingletonDependencySingleton.getInstance(),NextSingletonSingleton.getInstance());",
            "       Resources resources = new Resources(SingletonDependencySingleton.getInstance());",
            "       ParentDependency parentDependency = new ParentDependency(SingletonDependencySingleton.getInstance(),NextSingletonSingleton.getInstance(),dependencyModel,resources);",
            "       return parentDependency;",
            "   }",
            "}")
