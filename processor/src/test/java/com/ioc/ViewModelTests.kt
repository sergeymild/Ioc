...
class ViewModelTests {
    ...
    fun viewModel() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private final ActivityViewModel provideActivityViewModel(@NonNull final Activity target) {",
    ...
    fun liveDataObserverFromNamed() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private final ActivityViewModel2 provideActivityViewModel2(@NonNull final Activity target) {",
