...
class ViewModelTests {
    ...
    fun liveDataObserverFromGetterViewModel() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       };",
            "       ActivityViewModel activityViewModel = ViewModelProviders.of(target, factory_activityViewModel).get(ActivityViewModel.class);",
            "       target.setViewModel(activityViewModel);",
            "   }",
            "",
            "   private final void observeMutableLiveDataStringFromActivityViewModel(@NonNull final Activity target) {",
    ...
    fun liveDataObserverFromNamed() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   public final void inject(@NonNull final Activity target) {",
            "       injectActivityViewModelInActivityViewModel(target);",
            "       injectActivityViewModel2InActivityViewModel2(target);",
            "       observeMutableLiveDataStringFromActivityViewModel(target);",
            ...
            "   }",
            "",
            "   private final void injectActivityViewModel2InActivityViewModel2(@NonNull final Activity target) {",
            ...
            "       target.activityViewModel2 = activityViewModel2;",
            "   }",
            "",
            "   private final void observeMutableLiveDataStringFromActivityViewModel(@NonNull final Activity target) {",
            "       target.activityViewModel.stringLiveData.observe(target, new Observer<String>() {",
