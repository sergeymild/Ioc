...
class ViewModelTests {
    ...
    fun viewModel() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       target.activityViewModel = injectActivityViewModelInActivityViewModel(target);",
            "   }",
            "",
            "   private final ActivityViewModel injectActivityViewModelInActivityViewModel(@NonNull final Activity target) {",
    ...
    fun liveDataObserverFromViewModel() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private final void observeMutableLiveDataStringFromActivityViewModel(@NonNull final Activity target) {",
            ...
            "   }",
            "",
            "   private final void observeMutableLiveDataIntegerFromActivityViewModel(@NonNull final Activity target) {",
    ...
    fun liveDataObserverFromGetterViewModel() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   @Keep",
            "   public final void inject(@NonNull final Activity target) {",
            "       target.setViewModel(injectActivityViewModelInActivityViewModel(target));",
            "       observeMutableLiveDataStringFromActivityViewModel(target);",
            "   }",
            "",
            "   private final ActivityViewModel injectActivityViewModelInActivityViewModel(@NonNull final Activity target) {",
    ...
    fun liveDataObserverFromNamed() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   public final void inject(@NonNull final Activity target) {",
            "       target.activityViewModel = injectActivityViewModelInActivityViewModel(target);",
            "       target.activityViewModel2 = injectActivityViewModel2InActivityViewModel2(target);",
            "       observeMutableLiveDataStringFromActivityViewModel(target);",
            ...
            "   }",
            "",
            "   private final ActivityViewModel2 injectActivityViewModel2InActivityViewModel2(@NonNull final Activity target) {",
            ...
            "   }",
            "",
            "   private final void observeMutableLiveDataStringFromActivityViewModel2(@NonNull final Activity target) {",
    ...
    fun liveDataObserverNotMutable() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private final void observeLiveDataStringFromActivityViewModel(@NonNull final Activity target) {",
