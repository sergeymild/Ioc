...
class ScopesTest : BaseTest {
    ...
    fun nestedInjection() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.MainActivityInjector",
            ...
            "   }",
            "",
            "   private final PhoneBrowserUi providePhoneBrowserUi(@NonNull final MainActivity target) {",
            "       PhoneBrowserUi browserUi = new PhoneBrowserUi(target);",
            "       return browserUi;",
            "   }",
            "",
            "   private final SessionImplementation provideSessionImplementation(@NonNull final MainActivity target) {",
