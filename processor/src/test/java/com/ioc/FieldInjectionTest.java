...
public class FieldInjectionTest {
    ...
    public void providerField() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "         }",
                "       };",
                "       target.dependency = provider_dependencyModel;",
                "   }",
                "}");
    ...
    public void providerFieldWithInterface() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       Provider<DependencyInterface> provider_dependencyInterface = new Provider<DependencyInterface>() {",
                "         @Override",
                "         @NonNull",
                "         public DependencyInterface get() {",
                "           DependencyType dependencyInterface = new DependencyType();",
                "           return dependencyInterface;",
                "         }",
                "       };",
                "       target.dependency = provider_dependencyInterface;",
                "   }",
                "}");
    ...
    public void lazyFieldWithInterface() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectDependencyInterfaceInDependency(@NonNull final Activity target) {",
                "       Lazy<DependencyInterface> lazy_dependencyInterface = new Lazy<DependencyInterface>() {",
                "         private DependencyInterface value;",
                ...
                "           DependencyType dependencyInterface = new DependencyType();",
                "           value = dependencyInterface;",
                "           return value;",
                "         }",
                "       };",
                "       target.dependency = lazy_dependencyInterface;",
                "   }",
                "}");
    ...
    public void correctInjectionOrder() throws Exception {
        ...
        JavaFileObject activityFile = JavaFileObjects.forSourceLines("test.Activity",
                ...
                "",
                importType(Inject.class),
                importType(InjectPriority.class),
                "",
                "public class Activity {",
                "",
                "   @Inject @InjectPriority(2)",
                "   public ParentDependency parentDependency;",
                "   @Inject @InjectPriority(1)",
                "   public DependencyModel dependency;",
                "}");
    ...
    public void correctInjection6() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       Resource singleton_resource = ResourceSingleton.get();",
                "       DependencyModel dependencyModel = new DependencyModel(context, singleton_resource);",
                "       target.dependency = dependencyModel;",
                "   }",
                "}");
    ...
    public void findImplementationInParent() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectDependencyModelInDependency(@NonNull final Activity target) {",
                "       AppModel dependencyModel = new AppModel();",
                "       target.dependency = dependencyModel;",
                "   }",
                "}");
    ...
    public void findImplementationInParent2() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectDependencyModelInDependency(@NonNull final Activity target) {",
                "       Context singleton_context = ContextSingleton.get();",
                "       AppModel dependencyModel = new AppModel(singleton_context);",
                "       target.dependency = dependencyModel;",
                "   }",
                "}");
    ...
    public void twoInterfacesFromOnImplementationInConstructor() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       Amplitude singleton_amplitude = AmplitudeSingleton.get();",
                "       BaseModel baseModel = new BaseModel(singleton_amplitude, singleton_amplitude);",
    ...
    public void injectInParentClass() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       Amplitude singleton_amplitude = AmplitudeSingleton.get();",
                "       target.clickedEventLogger = singleton_amplitude;",
                "   }",
                "}");
    ...
    public void injectInParentClass1() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.LoggerSingleton",
                ...
                "       Amplitude singleton_amplitude = AmplitudeSingleton.get();",
                "       singleton = new Logger(singleton_amplitude, singleton_amplitude);",
                "       return singleton;",
                "   }",
                "}");
    ...
    public void twoInterfacesFromOnImplementationInConstructorForSingleton() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.DownloadsNavigationLoggerSingleton",
                ...
                "       if (singleton != null) return singleton;",
                "       AmplitudeService singleton_amplitudeService = AmplitudeServiceSingleton.get();",
                "       singleton = new DownloadsNavigationLogger(singleton_amplitudeService, singleton_amplitudeService);",
                "       return singleton;",
                "   }",
                "}");
    ...
    public void inject() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       Preferences singleton_preferences = PreferencesSingleton.get();",
                "       BuildCheck buildCheck = new BuildCheck(singleton_preferences);",
    ...
    public void injectTargetInDependency2() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       AmplitudeDefaultLogger singleton_amplitudeDefaultLogger = AmplitudeDefaultLoggerSingleton.get();",
                "       target.setLogger(singleton_amplitudeDefaultLogger);",
                "   }",
                "}");
    ...
    public void oneSingletonForDependencies() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "       AmplitudeDefaultLogger singleton_amplitudeDefaultLogger = AmplitudeDefaultLoggerSingleton.get();",
                "       Context context = ContextModule.context(singleton_amplitudeDefaultLogger);",
                "       Preferences preferences = new Preferences(context, singleton_amplitudeDefaultLogger);",
    ...
    public void providerModule() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectPresenterInPresenter(@NonNull final Activity target) {",
                "       Provider<Context> provider_context = new Provider<Context>() {",
                "           @Override",
                "           @NonNull",
                "           public Context get() {",
                "             Context context = ContextModule.context();",
                ...
                "           }",
                "       }",
                "       Presenter presenter = new Presenter(provider_context);",
                "       target.presenter = presenter;",
                "   }",
                "}");
    ...
    public void providerLazy() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectPresenterInPresenter(@NonNull final Activity target) {",
                "       Lazy<Context> lazy_context = new Lazy<Context>() {",
                ...
                "           }",
                "       }",
                "       Presenter presenter = new Presenter(lazy_context);",
                "       target.presenter = presenter;",
                "   }",
                "}");
    ...
    public void lazyParam() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "",
                "   private final void injectPresenterInPresenter(@NonNull final Activity target) {",
                "       Lazy<Presenter> lazy_presenter = new Lazy<Presenter>() {",
                ...
                "           }",
                "       }",
                "       target.presenter = lazy_presenter;",
                "   }",
                "}");
    ...
    public void moduleSingleton() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "   private final void injectPresenterInPresenter(@NonNull final Activity target) {",
                "       Context singleton_context = ContextSingleton.get();",
                "       Presenter presenter = ContextModule.presenter(singleton_context);",
                "       target.presenter = presenter;",
                "   }",
                "}");
    ...
    public void doNotpassTargetInSingleton2() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
                ...
                "   private final void injectPresenterInPresenter(@NonNull final Activity target) {",
                "       Context singleton_context = ContextSingleton.get();",
                "       Resource resource = new Resource(singleton_context);",
                "       Presenter presenter = new Presenter(singleton_context, resource);",
                "       target.presenter = presenter;",
                "   }",
                "}");
    ...
    public void providerInConstructor() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MainActivityInjector",
                ...
                "       Logger logger = new Logger();",
                "       Provider<FileManager> provider_fileManager = new Provider<FileManager>() {",
                "           @Override",
                "           @NonNull",
                ...
                "          }",
                "      };",
                "      Dependency dependency = new Dependency(logger, provider_fileManager);",
    ...
    public void lazyInConstructor() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MainActivityInjector",
                ...
                "   private final void injectDependencyInDependency(@NonNull final MainActivity target) {",
                "       Logger logger = new Logger();",
                "       Lazy<FileManager> lazy_fileManager = new Lazy<FileManager>() {",
                "           private FileManager value;",
                "",
                "           public boolean isInitialized() {",
                "               return value != null;",
                "           }",
                ...
                "          }",
                "      };",
                "      Dependency dependency = new Dependency(logger, lazy_fileManager);",
                "      target.dependency = dependency;",
                "   }",
                "}");
    ...
    @Test
    public void targetDependency() throws Exception {
        ...
        JavaFileObject activityFile = JavaFileObjects.forSourceLines("test.MyActivity",
                ...
                importType(Inject.class),
                importType(Context.class),
                importType(TargetDependency.class),
                "",
                ...
                "   public Preferences preferences;",
                "   @Inject",
                "   public SpeedDialDisplayedEventLogger logger;",
                "",
                "   @TargetDependency",
                "   public Context localContext() { return null; }",
                "}");
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MyActivityInjector",
                ...
                "   }",
                "",
                "   private final void injectPreferencesInPreferences(@NonNull final MyActivity target) {",
                "       Context context = target.localContext();",
                "       Preferences preferences = new Preferences(context);",
                "       target.preferences = preferences;",
                "   }",
                "",
                "   private final void injectSpeedDialDisplayedEventLoggerInLogger(@NonNull final MyActivity target) {",
                "       Context context = target.localContext();",
                "       Preferences preferences2 = new Preferences(context);",
                "       AmplitudeDefaultLogger speedDialDisplayedEventLogger = new AmplitudeDefaultLogger(preferences2);",
                "       target.logger = speedDialDisplayedEventLogger;",
                "   }",
                "}");

        assertAbout(javaSources())
                .that(Arrays.asList(activityFile, speedDialDisplayedEventLogger, preferences, amplitudeDefaultLogger, restModule))
                .processedWith(new IProcessor())
                .compilesWithoutError()
                .and().generatesSources(injectedFile);
    }
    ...
    @Test
    public void cachedSingletons() throws Exception {
        ...
        JavaFileObject databaseEventLogger = JavaFileObjects.forSourceLines("test.DatabaseEventLogger",
                "package test;",
                "",
                "public interface DatabaseEventLogger {",
                "}");
        ...
        JavaFileObject amplitudeDefaultLogger = JavaFileObjects.forSourceLines("test.AmplitudeDefaultLogger",
                ...
                "@Dependency",
                "@Singleton",
                "public class AmplitudeDefaultLogger implements SpeedDialDisplayedEventLogger, DatabaseEventLogger {",
                "   public AmplitudeDefaultLogger(Preferences preferences) {}",
                "}");
        ...
        JavaFileObject activityFile = JavaFileObjects.forSourceLines("test.MyActivity",
                ...
                "   public SpeedDialDisplayedEventLogger logger;",
                "   @Inject",
                "   public DatabaseEventLogger databaseLogger;",
                "",
                "   @TargetDependency",
                "   public Context localContext() { return null; }",
                "}");
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MyActivityInjector",
                ...
                "   @Keep",
                "   public final void inject(@NonNull final MyActivity target) {",
                "       injectDatabaseEventLoggerInDatabaseLogger(target);",
                "       injectSpeedDialDisplayedEventLoggerInLogger(target);",
                "   }",
                "",
                "   private final void injectDatabaseEventLoggerInDatabaseLogger(@NonNull final MyActivity target) {",
                "       AmplitudeDefaultLogger singleton_amplitudeDefaultLogger = AmplitudeDefaultLoggerSingleton.get();",
                "       target.databaseLogger = singleton_amplitudeDefaultLogger;",
                "   }",
                "",
                "   private final void injectSpeedDialDisplayedEventLoggerInLogger(@NonNull final MyActivity target) {",
                "       AmplitudeDefaultLogger singleton_amplitudeDefaultLogger = AmplitudeDefaultLoggerSingleton.get();",
                "       target.logger = singleton_amplitudeDefaultLogger;",
                "   }",
                "}");

        assertAbout(javaSources())
                .that(Arrays.asList(activityFile, speedDialDisplayedEventLogger, preferences, databaseEventLogger, amplitudeDefaultLogger))
                .processedWith(new IProcessor())
                .compilesWithoutError()
                .and().generatesSources(injectedFile);
    }
    ...
    public void cached() throws Exception {
        ...
        JavaFileObject activity2File = JavaFileObjects.forSourceLines("test.SecondActivity",
                "package test;",
                "",
                importType(Inject.class),
                importType(Context.class),
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MyActivityInjector",
                ...
                "       AmplitudeDefaultLogger databaseEventLogger2 = new AmplitudeDefaultLogger(preferences4);",
                "       target.databaseLogger = databaseEventLogger2;",
                "   }",
                "",
                "   private final void injectSpeedDialDisplayedEventLoggerInLogger(@NonNull final MyActivity target) {",
                "       Preferences preferences3 = new Preferences();",
                "       AmplitudeDefaultLogger speedDialDisplayedEventLogger2 = new AmplitudeDefaultLogger(preferences3);",
                "       target.logger = speedDialDisplayedEventLogger2;",
                "   }",
                "}");

        assertAbout(javaSources())
                .that(Arrays.asList(activity2File, activityFile, speedDialDisplayedEventLogger, preferences, databaseEventLogger, amplitudeDefaultLogger))
                .processedWith(new IProcessor())
                .compilesWithoutError()
                .and().generatesSources(injectedFile);
    }
    ...
    public void findParentOnInterface() {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.MyActivityInjector",
                ...
                "       Settings incognito = new Settings();",
    ...
    public void twoInterfacesFromOnImplementationInConstructorForSingleton2() throws Exception {
        ...
        JavaFileObject injectedFile = JavaFileObjects.forSourceLines("test.DownloadsNavigationLoggerSingleton",
                ...
                "       if (singleton != null) return singleton;",
                "       AmplitudeService singleton_amplitudeService = AmplitudeServiceSingleton.get();",
                "       singleton = new DownloadsNavigationLogger(singleton_amplitudeService);",
                "       return singleton;",
                "   }",
                "}");
