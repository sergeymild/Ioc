...
class WeakDependencyTests {
    ...
    fun fieldInjectWithoutParams() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       target.weakDependency = injectDependencyModelInWeakDependency();",
            "   }",
            "",
            "   private final WeakReference<DependencyModel> injectDependencyModelInWeakDependency() {",
    ...
    fun provideMethodInject() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private final WeakReference<DependencyModel> injectDependencyModelInDependency() {",
