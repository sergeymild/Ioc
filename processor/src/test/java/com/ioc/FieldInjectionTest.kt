...
class FieldInjectionTest {
    ...
    fun correctInjection6() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       DependencyModel dependencyModel = new DependencyModel(context,ResourceSingleton.getInstance());",
            "       return dependencyModel;",
            "   }",
            "}")
    ...
    fun findImplementationInParent2() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       AppModel dependencyModel = new AppModel(ContextSingleton.getInstance());",
            "       return dependencyModel;",
            "   }",
            "}")
    ...
    fun twoInterfacesFromOnImplementationInConstructor() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       BaseModel baseModel = new BaseModel(AmplitudeSingleton.getInstance(),AmplitudeSingleton.getInstance());",
            "       return baseModel;",
            "   }",
            "}")
    ...
    fun injectInParentClass2() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       target.closedEventLogger = AmplitudeSingleton.getInstance();",
            "       target.setEventLogger(AmplitudeSingleton.getInstance());",
            "   }",
            "}")
    ...
    fun injectInParentClass() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       target.clickedEventLogger = AmplitudeSingleton.getInstance();",
            "   }",
            "}")
    ...
    fun inject() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       BuildCheck buildCheck = new BuildCheck(PreferencesSingleton.getInstance());",
            "       return buildCheck;",
            "   }",
            "}")
    ...
    fun injectTargetInDependency2() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   @Keep",
            "   public static final void inject(@NonNull final Activity target) {",
            "       target.setLogger(AmplitudeDefaultLoggerSingleton.getInstance());",
            "   }",
            "}")
    ...
    fun oneSingletonForDependencies() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "       Context context = ContextModule.context(AmplitudeDefaultLoggerSingleton.getInstance());",
            "       Preferences preferences = new Preferences(context,AmplitudeDefaultLoggerSingleton.getInstance());",
            "       return preferences;",
            "   }",
            "}")
    ...
    fun moduleSingleton() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "",
            "   public static final Presenter providePresenter() {",
            "       Presenter presenter = ContextModule.presenter(ContextSingleton.getInstance());",
            "       return presenter;",
            "   }",
            "}")
    ...
    fun doNotpassTargetInSingleton2() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "",
            "   public static final Presenter providePresenter() {",
            "       Resource resource = new Resource(ContextSingleton.getInstance());",
            "       Presenter presenter = new Presenter(ContextSingleton.getInstance(),resource);",
            "       return presenter;",
            "   }",
            "}")
