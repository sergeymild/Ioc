...
class ModuleTests {
    ...
    fun injectStringFromModuleMethod() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private static final Service provideService() {",
    ...
    fun kotlinModuleInFieldWithParameter() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private static final CountryService provideCountryService() {",
    ...
    fun kotlinModuleInConstructor() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private static final CountryProvider provideCountryProvider() {",
    ...
    fun kotlinModuleSingletonParameter() {
        ...
        val injectedFile = JavaFileObjects.forSourceLines("test.ActivityInjector",
            ...
            "   }",
            "",
            "   private static final Factory provideFactory() {",
