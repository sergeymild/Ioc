...
abstract class DelegatingClassBuilder constructor(val delegatingClassBuilder: ClassBuilder) : org.jetbrains.kotlin.codegen.DelegatingClassBuilder() {
    override fun getDelegate(): ClassBuilder = delegatingClassBuilder
}

class DebugLogClassGenerationInterceptor constructor(
